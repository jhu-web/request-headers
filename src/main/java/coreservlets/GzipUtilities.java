 ...
 * <LI>isGzipDisabled: has the user passed in a flag saying that gzip encoding should be
 * disabled for this request? (Useful so that you can measure results with and without
 * gzip on the same browser).
