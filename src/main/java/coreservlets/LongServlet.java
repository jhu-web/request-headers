...
/**
 * Servlet with <B>long</B> output. Used to test the effect of the gzip compression.
 * <p>
...
public class LongServlet
  extends HttpServlet {

  private static final long serialVersionUID = 5060033872418621223L;
